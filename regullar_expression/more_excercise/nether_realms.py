...
# мачва всички чаръктъри без (0-9), arithmetic symbols ('+', '-', '*', '/', '.')
# с това създавам хелта

# мачва тире - може и да го има, може и да го няма
# мачва група - 0 или 0-9 в низ, след това мачва 0-9 и точка нула и един пъти
# всичко това като се разпечата в цяла група се мачва с - отпред
# това създава демиджа
